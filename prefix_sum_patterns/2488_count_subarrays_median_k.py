...
class Solution: 
    ...
    def count_subarrays(self, nums: List[int], k: int) -> int: 
        ...
        res = count{[4], [4,5], [1,4,5], [2,1,4,5,6], [1,4,5,6]}


        let's do for 
        [3,2,1,5,6,7,4] and k = 5
        ...
        res = count{[5], [1,5,6],[1,5,6,7], [2,1,5,6,7]}
...
print(s.count_subarrays([3,2,1,5,6,7,4] , 5))
print(s.count_subarrays([3,2,1,4,5,6], 4))